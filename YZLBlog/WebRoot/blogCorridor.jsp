...
<div id="title"><strong><span id="zx1"><%=session.getAttribute("title1new") %></span>&nbsp;</strong><span id="pubTime"><%=session.getAttribute("time1new") %></span>&nbsp;<span id="readNum">阅读(<%=session.getAttribute("read1new") %>)</span></div>
<div align="center" id="h1"><span id="paperTitle"><%=session.getAttribute("title1new") %></span></div>
<%=session.getAttribute("content1new") %>   
...
<div class="docs-content">
<div id="blogContainer">  
<div id="title"><strong><span id="zx2"><%=session.getAttribute("title2new") %></span>&nbsp;</strong><span id="pubTime"><%=session.getAttribute("time2new") %></span>&nbsp;<span id="readNum">阅读(<%=session.getAttribute("read2new") %>)</span></div>
<div align="center" id="h1"><span id="paperTitle"><%=session.getAttribute("title2new") %></span></div>
<%=session.getAttribute("content2new") %>
<div class="comment">
评论[1]
</div>
...
<h2>精彩博文</h2>
<div id="blogContainer">  
<div id="title"><strong><span id="jc1"><%=session.getAttribute("title1won") %></span>&nbsp;</strong><span id="pubTime"><%=session.getAttribute("time1won") %></span>&nbsp;<span id="readNum">阅读(<%=session.getAttribute("read1won") %>)</span></div>
