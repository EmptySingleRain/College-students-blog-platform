...
<jsp:useBean id="myimg" class="mybean.Image"></jsp:useBean>
...
<div id="container">
	<div id="parameter">
		<div id="author">
			<p class="mypic">
			<%
			ResultSet rs = myimg.myUserImage(session.getAttribute("bloggername").toString());
			while(rs.next()){
			str = rs.getString("imgpath");
			session.setAttribute("myimg",str);
			}		
			%>
			<img src="<%=session.getAttribute("myimg")%>"> </p>
<p><font color="red"><%=session.getAttribute("bloggername") %></font>&nbsp;的BLOG</p>
		</div>
		<div id="llinks">
			<h4 class="links"><span>活力地带</span></h4>
			<ul>
				<li><img src="blogger/images/1.gif"> <a href="blogger/blogger.jsp">个人首页</a></li>
				<li><img src="blogger/images/3.gif"> <a href="blogger/blogger.jsp">控制面板</a></li>
				<li><img src="blogger/images/4.gif"> <a href="blogger/myArticle.jsp">我的文章</a></li>
				<li><img src="blogger/images/5.gif"> <a href="blogger/blogger.jsp">我的相册</a></li>
				<li><img src="blogger/images/6.gif"> <a href="blogger/blogger.jsp">我的圈子</a></li>
				<li><img src="blogger/images/2.gif"> <a href="blogger/comment.jsp">给我留言</a></li>
			</ul>
			<br>
		</div>
		<div id="lcategory">
			...
			<ul>
				<li><a href="blogger/blogger.jsp">个人随笔</a></li>
				<li><a href="blogger/blogger.jsp">美术设计</a></li>
				<li><a href="blogger/blogger.jsp">CSS样式风格</a></li>
				<li><a href="blogger/blogger.jsp">Ajax学习心得</a></li>
				<li><a href="blogger/blogger.jsp">新疆甘肃游记</a></li>
				<li><a href="blogger/blogger.jsp">学生节</a></li>
				<li><a href="blogger/blogger.jsp">职业生涯</a></li>
			</ul>
			<br>
		</div>
		<div id="llatest">
			...
			<ul>
				<li><a href="blogger/blogger.jsp">学生节(6)_释放天性</a></li>
				<li><a href="blogger/blogger.jsp">学生节(5)_beep的越洋电话</a></li>
				<li><a href="blogger/blogger.jsp">学生节(4)_主持人选拔</a></li>
				<li><a href="blogger/blogger.jsp">学生节(3)_十届的电子人</a></li>
				<li><a href="blogger/blogger.jsp">学生节(2)_5秒定律永不倒</a></li>
				<li><a href="blogger/blogger.jsp">学生节(1)_综述</a></li>
				<li><a href="blogger/blogger.jsp">吃住在新疆</a></li>
				<li><a href="blogger/blogger.jsp">Ajax实现可拖动的页面</a></li>
				<li><a href="blogger/blogger.jsp">巧学巧用Flash</a></li>
			</ul>
			<br>
		</div>
		<div id="lcomment">
			...
			<ul>
				<li><a href="blogger/blogger.jsp">[isaac] 关于beep的话题</a></li>
				<li><a href="blogger/blogger.jsp">[tastestory] 哈哈</a></li>
				<li><a href="blogger/blogger.jsp">[moonbow] 还是露天，真的吗？</li>
				<li><a href="blogger/blogger.jsp">[isaac] zan :)</a></li>
				<li><a href="blogger/blogger.jsp">[bingri] 来总导这里挖坑~~</a></li>
				<li><a href="blogger/blogger.jsp">[inming] 博士加油</a></li>
			</ul>
			<br>
		</div>
		<div id="lfriend">
			...
			<ul>
				<li><a href="blogger/blogger.jsp">闪客帝国</a></li>
				<li><a href="blogger/blogger.jsp">自由空间</a></li>
				<li><a href="blogger/blogger.jsp">一起走到</a></li>
				<li><a href="blogger/blogger.jsp">从明天起</a></li>
				<li><a href="blogger/blogger.jsp">纸飞机</a></li>
				<li><a href="blogger/blogger.jsp">下一站</a></li>
			</ul>
			<br>
		</div>
	</div>
	<div id="main">
		<div class="article">
			<h3><a href="blogger/blogger.jsp">学生节(6)_释放天性</a></h3>
